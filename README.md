...
|      Create project                                                                                                     |     Route                                                                          | Twig                                                                                                          | Asset                                                                                           |
| ----------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| <a href="https://github.com/emiliesappracone/symfony_read#start-">Start</a>                                             | <a href="https://github.com/emiliesappracone/symfony_read#bundles-"> Routes</a>    | <a href="https://github.com/emiliesappracone/symfony_read#twig-"> Twig</a>                                    | <a href="https://github.com/emiliesappracone/symfony_read#assets"> Assets</a>                   |
| <a href="https://github.com/emiliesappracone/symfony_read#bundles-"> Bundles</a>                                        |                                                                                    | <a href="https://github.com/emiliesappracone/symfony_read#my-twig-structure-for-symfony-">Structure</a>       |                                                                                                 |                                                                                       
